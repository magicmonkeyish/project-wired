...
void Enchant(Player* player, Item* item, uint32 enchantid)
{
    ...
    player->GetSession()->SendNotification("|cFF00FF00%s |cffFF0000succesfully enchanted!", item->GetTemplate()->Name1.c_str());
}
    ...
    npc_enchantment() : CreatureScript("npc_enchantment") { }
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            if (player->HasSkill(SKILL_ENCHANTING) && player->GetSkillValue(SKILL_ENCHANTING) == 450)
                        {
                player->ADD_GOSSIP_ITEM(4, " Enchant Rings", GOSSIP_SENDER_MAIN, 12);
                        }
                        player->ADD_GOSSIP_ITEM(5, " I wish to remove my enchant", GOSSIP_SENDER_MAIN, 14);
 
            player->PlayerTalkClass->SendGossipMenu(50011, creature->GetGUID());
                        return true;
                }
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
        {
            ...
            switch (action)
            {
                ...
                case 1: // Enchant Weapon
                    if (player->HasSkill(SKILL_ENCHANTING) && player->GetSkillValue(SKILL_ENCHANTING) == 450)
                    {
                        player->ADD_GOSSIP_ITEM(9, "Blade Ward", GOSSIP_SENDER_MAIN, 102);
                        player->ADD_GOSSIP_ITEM(9, "Blood Draining", GOSSIP_SENDER_MAIN, 103);
                    }
                    player->ADD_GOSSIP_ITEM(9, "Exceptional Agility", GOSSIP_SENDER_MAIN, 100);
                    player->ADD_GOSSIP_ITEM(9, "Exceptional Spirit", GOSSIP_SENDER_MAIN, 101);
                    player->ADD_GOSSIP_ITEM(9, "Berserking", GOSSIP_SENDER_MAIN, 104);
                    player->ADD_GOSSIP_ITEM(9, "Accuracy", GOSSIP_SENDER_MAIN, 105);
                    player->ADD_GOSSIP_ITEM(9, "Black Magic", GOSSIP_SENDER_MAIN, 106);
                    player->ADD_GOSSIP_ITEM(9, "Battlemaster", GOSSIP_SENDER_MAIN, 107);
                    player->ADD_GOSSIP_ITEM(9, "Icebreaker", GOSSIP_SENDER_MAIN, 108);
                    player->ADD_GOSSIP_ITEM(9, "Lifeward", GOSSIP_SENDER_MAIN, 109);
                    player->ADD_GOSSIP_ITEM(9, "Titanguard", GOSSIP_SENDER_MAIN, 110);
                    player->ADD_GOSSIP_ITEM(9, "Superior Potency", GOSSIP_SENDER_MAIN, 111);
                    player->ADD_GOSSIP_ITEM(9, "Mighty Spellpower", GOSSIP_SENDER_MAIN, 112);
                    player->ADD_GOSSIP_ITEM(9, "Mongoose", GOSSIP_SENDER_MAIN, 113);
                    player->ADD_GOSSIP_ITEM(9, "Executioner", GOSSIP_SENDER_MAIN, 114);
                ...
                case 2: // Enchant 2H Weapon
                                        {
                                                ...
                                                {
                                                        player->ADD_GOSSIP_ITEM(9, "Berserking", GOSSIP_SENDER_MAIN, 104);
                                                        player->ADD_GOSSIP_ITEM(9, "Greater Spellpower", GOSSIP_SENDER_MAIN, 115);
                                                        player->ADD_GOSSIP_ITEM(9, "Major Agility", GOSSIP_SENDER_MAIN, 116);
                                                        player->ADD_GOSSIP_ITEM(9, "Massacre", GOSSIP_SENDER_MAIN, 117);
                                                        player->ADD_GOSSIP_ITEM(9, "Mongoose", GOSSIP_SENDER_MAIN, 113);
                                                        player->ADD_GOSSIP_ITEM(9, "Executioner", GOSSIP_SENDER_MAIN, 114);
                                                        player->ADD_GOSSIP_ITEM(7, "<-Back", GOSSIP_SENDER_MAIN, 300);
                ...
                case 3: // Enchant Shield
                                        {
                                                ...
                                                {
                                                        player->ADD_GOSSIP_ITEM(4, "Defense", GOSSIP_SENDER_MAIN, 118);
                                                        player->ADD_GOSSIP_ITEM(4, "Greater Intellect", GOSSIP_SENDER_MAIN, 119);
                                                        player->ADD_GOSSIP_ITEM(4, "Resilience", GOSSIP_SENDER_MAIN, 120);
                                                        player->ADD_GOSSIP_ITEM(4, "Titanium Plating", GOSSIP_SENDER_MAIN, 121);
                                                        player->ADD_GOSSIP_ITEM(4, "Major Stamina", GOSSIP_SENDER_MAIN, 122);
                                                        player->ADD_GOSSIP_ITEM(4, "Tough Shield", GOSSIP_SENDER_MAIN, 123);
                                                        player->ADD_GOSSIP_ITEM(7, "<-Back", GOSSIP_SENDER_MAIN, 300);
                ...
                case 4: // Enchant Head
                    player->ADD_GOSSIP_ITEM(4, "Arcanum of Blissful Mending", GOSSIP_SENDER_MAIN, 124);
                    player->ADD_GOSSIP_ITEM(4, "Arcanum of Burning Mysteries", GOSSIP_SENDER_MAIN, 125);
                    player->ADD_GOSSIP_ITEM(4, "Arcanum of Dominance", GOSSIP_SENDER_MAIN, 126);
                    player->ADD_GOSSIP_ITEM(4, "Arcanum of The Savage Gladiator", GOSSIP_SENDER_MAIN, 127);
                    player->ADD_GOSSIP_ITEM(4, "Arcanum of The Stalwart Protector", GOSSIP_SENDER_MAIN, 128);
                    player->ADD_GOSSIP_ITEM(4, "Arcanum of Torment", GOSSIP_SENDER_MAIN, 129);
                    player->ADD_GOSSIP_ITEM(4, "Arcanum of Triumph", GOSSIP_SENDER_MAIN, 130);
                                        player->ADD_GOSSIP_ITEM(4, "Arcanum of Eclipsed Moon", GOSSIP_SENDER_MAIN, 131);
                                        player->ADD_GOSSIP_ITEM(4, "Arcanum of the Flame's Soul", GOSSIP_SENDER_MAIN, 132);
                                        player->ADD_GOSSIP_ITEM(4, "Arcanum of the Fleeing Shadow", GOSSIP_SENDER_MAIN, 133);
                                        player->ADD_GOSSIP_ITEM(4, "Arcanum of the Frosty Soul", GOSSIP_SENDER_MAIN, 134);
                                        player->ADD_GOSSIP_ITEM(4, "Arcanum of Toxic Warding", GOSSIP_SENDER_MAIN, 135);
                                        player->ADD_GOSSIP_ITEM(7, "<-Back", GOSSIP_SENDER_MAIN, 300);
                ...
                case 5: // Enchant Shoulders
                    ...
                    {
                        player->ADD_GOSSIP_ITEM(4, "Master's Inscription of the Axe", GOSSIP_SENDER_MAIN, 136);
                        player->ADD_GOSSIP_ITEM(4, "Master's Inscription of the Crag", GOSSIP_SENDER_MAIN, 137);
                        player->ADD_GOSSIP_ITEM(4, "Master's Inscription of the Pinnacle", GOSSIP_SENDER_MAIN, 138);
                        player->ADD_GOSSIP_ITEM(4, "Master's Inscription of the Storm", GOSSIP_SENDER_MAIN, 139);
                    }
                    player->ADD_GOSSIP_ITEM(4, "Greater Inscription of the Axe", GOSSIP_SENDER_MAIN, 140);
                    player->ADD_GOSSIP_ITEM(4, "Greater Inscription of the Crag", GOSSIP_SENDER_MAIN, 141);
                    player->ADD_GOSSIP_ITEM(4, "Greater Inscription of the Pinnacle", GOSSIP_SENDER_MAIN, 142);
                    player->ADD_GOSSIP_ITEM(4, "Greater Inscription of the Gladiator", GOSSIP_SENDER_MAIN, 143);
                    player->ADD_GOSSIP_ITEM(4, "Greater Inscription of the Storm", GOSSIP_SENDER_MAIN, 144);
                    player->ADD_GOSSIP_ITEM(4, "Inscription of Dominance", GOSSIP_SENDER_MAIN, 145);
                    player->ADD_GOSSIP_ITEM(4, "Inscription of Triumph", GOSSIP_SENDER_MAIN, 146);
                                        player->ADD_GOSSIP_ITEM(7, "<-Back", GOSSIP_SENDER_MAIN, 300);
                ...
                case 6: // Enchant Cloak
                    player->ADD_GOSSIP_ITEM(4, "Springy Arachnoweave", GOSSIP_SENDER_MAIN, 147);
                    player->ADD_GOSSIP_ITEM(4, "Shadow Armor", GOSSIP_SENDER_MAIN, 148);                    
                    player->ADD_GOSSIP_ITEM(4, "Darkglow Embroidery", GOSSIP_SENDER_MAIN, 149);
                    player->ADD_GOSSIP_ITEM(4, "Lightweave Embroidery", GOSSIP_SENDER_MAIN, 150);
                    player->ADD_GOSSIP_ITEM(4, "Swordguard Embroidery", GOSSIP_SENDER_MAIN, 151);                    
                    player->ADD_GOSSIP_ITEM(4, "Wisdom", GOSSIP_SENDER_MAIN, 152);
                    player->ADD_GOSSIP_ITEM(4, "Titanweave", GOSSIP_SENDER_MAIN, 153);
                    player->ADD_GOSSIP_ITEM(4, "Spell Piercing", GOSSIP_SENDER_MAIN, 154);
                    player->ADD_GOSSIP_ITEM(4, "Mighty Armor", GOSSIP_SENDER_MAIN, 155);
                    player->ADD_GOSSIP_ITEM(4, "Major Agility", GOSSIP_SENDER_MAIN, 156);
                    player->ADD_GOSSIP_ITEM(4, "Greater Speed", GOSSIP_SENDER_MAIN, 157);
                                        player->ADD_GOSSIP_ITEM(7, "<-Back", GOSSIP_SENDER_MAIN, 300);
                    player->PlayerTalkClass->SendGossipMenu(100007, creature->GetGUID());
                                ...
                                case 7: //Enchant chest
                                        player->ADD_GOSSIP_ITEM(4, "Powerful Stats", GOSSIP_SENDER_MAIN, 158);
                                        player->ADD_GOSSIP_ITEM(4, "Super Health", GOSSIP_SENDER_MAIN, 159);
                                        player->ADD_GOSSIP_ITEM(4, "Greater Mana Restoration", GOSSIP_SENDER_MAIN, 160);
                                        player->ADD_GOSSIP_ITEM(4, "Exceptional Resilience", GOSSIP_SENDER_MAIN, 161);
                                        player->ADD_GOSSIP_ITEM(4, "Greater Defense", GOSSIP_SENDER_MAIN, 162);
                                        player->ADD_GOSSIP_ITEM(7, "<-Back", GOSSIP_SENDER_MAIN, 300);
                                ...
                                case 8: //Enchant Bracers
                                        player->ADD_GOSSIP_ITEM(4, "Major Stamina", GOSSIP_SENDER_MAIN, 163);
                                        player->ADD_GOSSIP_ITEM(4, "Superior Spell Power", GOSSIP_SENDER_MAIN, 164);
                                        player->ADD_GOSSIP_ITEM(4, "Greater Assult", GOSSIP_SENDER_MAIN, 165);
                                        player->ADD_GOSSIP_ITEM(4, "Major Spirit", GOSSIP_SENDER_MAIN, 166);
                                        player->ADD_GOSSIP_ITEM(4, "Expertise", GOSSIP_SENDER_MAIN, 167);
                                        player->ADD_GOSSIP_ITEM(4, "Greater Stats", GOSSIP_SENDER_MAIN, 168);
                                        player->ADD_GOSSIP_ITEM(4, "Exceptional Intellect", GOSSIP_SENDER_MAIN, 169);
                                        player->ADD_GOSSIP_ITEM(4, "Fur Lining - Arcane Resist", GOSSIP_SENDER_MAIN, 170);
                                        player->ADD_GOSSIP_ITEM(4, "Fur Lining - Fire Resist", GOSSIP_SENDER_MAIN, 171);
                                        player->ADD_GOSSIP_ITEM(4, "Fur Lining - Frost Resist", GOSSIP_SENDER_MAIN, 172);
                                        player->ADD_GOSSIP_ITEM(4, "Fur Lining - Nature Resist", GOSSIP_SENDER_MAIN, 173);
                                        player->ADD_GOSSIP_ITEM(4, "Fur Lining - Shadow Resist", GOSSIP_SENDER_MAIN, 174);
                                        player->ADD_GOSSIP_ITEM(4, "Fur Lining - Attack power", GOSSIP_SENDER_MAIN, 175);
                                        player->ADD_GOSSIP_ITEM(4, "Fur Lining - Stamina", GOSSIP_SENDER_MAIN, 176);
                                        player->ADD_GOSSIP_ITEM(4, "Fur Lining - Spellpower", GOSSIP_SENDER_MAIN, 177);
                                        player->ADD_GOSSIP_ITEM(7, "<-Back", GOSSIP_SENDER_MAIN, 300);
                                ...
                                case 9: //Enchant Gloves
                                        player->ADD_GOSSIP_ITEM(4, "Greater Blasting", GOSSIP_SENDER_MAIN, 178);
                                        player->ADD_GOSSIP_ITEM(4, "Armsman", GOSSIP_SENDER_MAIN, 179);
                                        player->ADD_GOSSIP_ITEM(4, "Crusher", GOSSIP_SENDER_MAIN, 180);
                                        player->ADD_GOSSIP_ITEM(4, "Agility", GOSSIP_SENDER_MAIN, 181);
                                        player->ADD_GOSSIP_ITEM(4, "Precision", GOSSIP_SENDER_MAIN, 182);
                                        player->ADD_GOSSIP_ITEM(4, "Expertise", GOSSIP_SENDER_MAIN, 183);
                                        player->ADD_GOSSIP_ITEM(7, "<-Back", GOSSIP_SENDER_MAIN, 300);
                                ...
                                case 10: //Enchant legs
                                        player->ADD_GOSSIP_ITEM(4, "Earthen Leg Armor", GOSSIP_SENDER_MAIN, 184);
                                        player->ADD_GOSSIP_ITEM(4, "Frosthide Leg Armor", GOSSIP_SENDER_MAIN, 185);
                                        player->ADD_GOSSIP_ITEM(4, "Icescale Leg Armor", GOSSIP_SENDER_MAIN, 186);
                                        player->ADD_GOSSIP_ITEM(4, "Brilliant Spellthread", GOSSIP_SENDER_MAIN, 187);
                                        player->ADD_GOSSIP_ITEM(4, "Sapphire Spellthread", GOSSIP_SENDER_MAIN, 188);
                                        player->ADD_GOSSIP_ITEM(4, "Dragonscale Leg Armor", GOSSIP_SENDER_MAIN, 189);
                                        player->ADD_GOSSIP_ITEM(4, "Wyrmscale Leg Armor", GOSSIP_SENDER_MAIN, 190);
                                        player->ADD_GOSSIP_ITEM(7, "<-Back", GOSSIP_SENDER_MAIN, 300);
                                ...
                                case 11: //Enchant feet
                                        player->ADD_GOSSIP_ITEM(4, "Greater Assult", GOSSIP_SENDER_MAIN, 191);
                                        player->ADD_GOSSIP_ITEM(4, "Tuskars Vitliaty", GOSSIP_SENDER_MAIN, 192);
                                        player->ADD_GOSSIP_ITEM(4, "Superior Agility", GOSSIP_SENDER_MAIN, 193);
                                        player->ADD_GOSSIP_ITEM(4, "Greater Spirit", GOSSIP_SENDER_MAIN, 194);
                                        player->ADD_GOSSIP_ITEM(4, "Greater Vitality", GOSSIP_SENDER_MAIN, 195);
                                        player->ADD_GOSSIP_ITEM(4, "Icewalker", GOSSIP_SENDER_MAIN, 196);
                                        player->ADD_GOSSIP_ITEM(4, "Greater Fortitude", GOSSIP_SENDER_MAIN, 197);
                                        player->ADD_GOSSIP_ITEM(4, "Nitro Boots", GOSSIP_SENDER_MAIN, 198);
                                        player->ADD_GOSSIP_ITEM(4, "Hand-Mounted Pyro Rocket", GOSSIP_SENDER_MAIN, 199);
                                        player->ADD_GOSSIP_ITEM(4, "Hyperspeed Accedlerators", GOSSIP_SENDER_MAIN, 200);
                                        player->ADD_GOSSIP_ITEM(4, "Reticulated Armor Webbing", GOSSIP_SENDER_MAIN, 201);
                                        player->ADD_GOSSIP_ITEM(7, "<-Back", GOSSIP_SENDER_MAIN, 300);
                                ...
                                case 12: //Enchant rings
                                        player->ADD_GOSSIP_ITEM(4, "Assult", GOSSIP_SENDER_MAIN, 202);
                                        player->ADD_GOSSIP_ITEM(4, "Greater Spell Power", GOSSIP_SENDER_MAIN, 203);
                                        player->ADD_GOSSIP_ITEM(4, "Stamina", GOSSIP_SENDER_MAIN, 204);
                                        player->ADD_GOSSIP_ITEM(7, "<-Back", GOSSIP_SENDER_MAIN, 300);
                                ...
                                case 13: //Enchant Off-Hand weapons
                                        {
                                                ...
                                                {
                                                        player->ADD_GOSSIP_ITEM(9, "Blade Ward", GOSSIP_SENDER_MAIN, 205);
                                                        player->ADD_GOSSIP_ITEM(9, "Blood Draining", GOSSIP_SENDER_MAIN, 219);
                                                        player->ADD_GOSSIP_ITEM(9, "Exceptional Agility", GOSSIP_SENDER_MAIN, 206);
                                                        player->ADD_GOSSIP_ITEM(9, "Exceptional Spirit", GOSSIP_SENDER_MAIN, 207);
                                                        player->ADD_GOSSIP_ITEM(9, "Berserking", GOSSIP_SENDER_MAIN, 208);
                                                        player->ADD_GOSSIP_ITEM(9, "Accuracy", GOSSIP_SENDER_MAIN, 209);
                                                        player->ADD_GOSSIP_ITEM(9, "Black Magic", GOSSIP_SENDER_MAIN, 210);
                                                        player->ADD_GOSSIP_ITEM(9, "Battlemaster", GOSSIP_SENDER_MAIN, 211);
                                                        player->ADD_GOSSIP_ITEM(9, "Icebreaker", GOSSIP_SENDER_MAIN, 212);
                                                        player->ADD_GOSSIP_ITEM(9, "Lifeward", GOSSIP_SENDER_MAIN, 213);
                                                        player->ADD_GOSSIP_ITEM(9, "Titanguard", GOSSIP_SENDER_MAIN, 214);
                                                        player->ADD_GOSSIP_ITEM(9, "Superior Potency", GOSSIP_SENDER_MAIN, 215);
                                                        player->ADD_GOSSIP_ITEM(9, "Mighty Spellpower", GOSSIP_SENDER_MAIN, 216);
                                                        player->ADD_GOSSIP_ITEM(9, "Mongoose", GOSSIP_SENDER_MAIN, 217);
                                                        player->ADD_GOSSIP_ITEM(9, "Executioner", GOSSIP_SENDER_MAIN, 218);
                                                        player->ADD_GOSSIP_ITEM(7, "<-Back", GOSSIP_SENDER_MAIN, 300);
                                                        player->PlayerTalkClass->SendGossipMenu(100002, creature->GetGUID());
                                                        return true;
                                                }
                                ...
                                case 14: //Remove enchant menu
                                        player->ADD_GOSSIP_ITEM(4, "Remove enchant on Main-hand", GOSSIP_SENDER_MAIN, 400);
                                        player->ADD_GOSSIP_ITEM(4, "Remove enchant on Off-hand", GOSSIP_SENDER_MAIN, 401);
                                        player->ADD_GOSSIP_ITEM(4, "Remove enchant on Head", GOSSIP_SENDER_MAIN, 402);
                                        player->ADD_GOSSIP_ITEM(4, "Remove enchant on Shoulders", GOSSIP_SENDER_MAIN, 403);
                                        player->ADD_GOSSIP_ITEM(4, "Remove enchant on Cloak", GOSSIP_SENDER_MAIN, 404);
                                        player->ADD_GOSSIP_ITEM(4, "Remove enchant on Chest", GOSSIP_SENDER_MAIN, 405);
                                        player->ADD_GOSSIP_ITEM(4, "Remove enchant on Bracers", GOSSIP_SENDER_MAIN, 406);
                                        player->ADD_GOSSIP_ITEM(4, "Remove enchant on Gloves", GOSSIP_SENDER_MAIN, 407);
                                        player->ADD_GOSSIP_ITEM(4, "Remove enchant on Legs", GOSSIP_SENDER_MAIN, 408);
                                        player->ADD_GOSSIP_ITEM(4, "Remove enchant on Feet", GOSSIP_SENDER_MAIN, 409);
                                        player->ADD_GOSSIP_ITEM(4, "Remove enchant on Rings", GOSSIP_SENDER_MAIN, 409);
                                        player->ADD_GOSSIP_ITEM(7, "<-Back", GOSSIP_SENDER_MAIN, 300);
                                ...
                                case 300: //<-Back menu
                                        {
                                                ...
                                                player->ADD_GOSSIP_ITEM(4, "[-I wish to remove my enchant-]", GOSSIP_SENDER_MAIN, 14);

...
#endif
#if SET_CURRENCY == 1
#define BOUNTY_1 "Place a 250 honor bounty."
#define BOUNTY_2 "Place a 500 honor bounty."
#define BOUNTY_3 "Place a 1000 honor bounty."
#define BOUNTY_4 "Place a 2000 honor bounty."
#endif
#if SET_CURRENCY == 2
				...
				if(passChecks(pPlayer, code))
				{
					...
					switch (uiAction)
					{
						case GOSSIP_ACTION_INFO_DEF+5:
						{
							...
							{
								#if SET_CURRENCY != 2
								CharacterDatabase.PExecute("INSERT INTO bounties VALUES('%u','250', '1')", pBounty->GetGUID());
								#else
						...
						case GOSSIP_ACTION_INFO_DEF+6:
						{
							...
							{
								#if SET_CURRENCY != 2
								CharacterDatabase.PExecute("INSERT INTO bounties VALUES('%u', '500', '2')", pBounty->GetGUID());
								#else

    ...
    struct mob_mature_netherwing_drakeAI : public ScriptedAI
    {
        mob_mature_netherwing_drakeAI(Creature* creature) : ScriptedAI(creature) 
			...
			/*void MoveInLineOfSight(Unit* pWho)
			{
				...
				if (pWho->GetTypeId() == TYPEID_UNIT && me->IsWithinDistInMap(pWho, 35.0f) && me->IsWithinLOSInMap(pWho) && hasfired == false && pWho->GetName() == "Delvin Fardale" )
				{
			...
			void UpdateAI(uint32 diff)
			{
				if (resettimer <= diff)
				{
					...
					case 0:
					if(Creature * c = me->FindNearestCreature(500150, 50.0f, true))
					{
					me->CastSpell(me, 27564);
					c->CastSpell(me, 37057);
					resettimer = 600000;
					}
					break;

					case 1:
					if(Creature * c = me->FindNearestCreature(500147, 50.0f, true))
					{
					me->CastSpell(me, 27564);
					c->CastSpell(me, 37057);
					resettimer = 600000;
					...
					case 2:
					if(Creature * c = me->FindNearestCreature(19859, 50.0f, true))
					{
					me->CastSpell(me, 27564);
					c->CastSpell(me, 37057);
					resettimer = 600000;
					...
					case 3:
					if(Creature * c = me->FindNearestCreature(900005, 50.0f, true))
					{
					me->CastSpell(me, 27564);
					c->CastSpell(me, 37057);
					resettimer = 600000;
